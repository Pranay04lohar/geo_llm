...
What: REST API endpoints for managing user chat conversations and messages
Why: Enable persistent chat history per user with CRUD operations
How: FastAPI router with Firebase authentication integration
"""
