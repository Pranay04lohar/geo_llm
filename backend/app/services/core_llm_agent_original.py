...
The original monolithic code is preserved in core_llm_agent_legacy.py for reference.
"""

# 
# REFACTORING NOTICE: This file now redirects to the new modular implementation
# 
# The monolithic core_llm_agent.py (1900+ lines) has been refactored into a clean,
# modular pipeline architecture located in the core_llm_agent/ directory.
#
# For backward compatibility, this file now imports and re-exports the new implementation.
# The original monolithic code is preserved in core_llm_agent_legacy.py for reference.
#
...
from .core_llm_agent import CoreLLMAgent
